...
<a class="brand" href=""></a>
    ...
    <li  class="pull-left" style=" border-right: none"><i class="fa fa-phone" style="padding-top:15px;font-size:16px"></i></li>
    <li  class="" style=" border-right: none"><a  href="#">Assistance: <strong>(+237) 0000 00 00</strong></a></li>
  
     </ul>
             <ul class="nav navbar-nav pull-right">
		
    <li  class="" style="  border-left: 1px   solid #555753;"><a  href="#"><strong>Nous contacter</strong></a></li>
   
		<li  class="" style=""><?php if(!isset ($_SESSION['email']) ){?><a  href="log/ins_login.php" class="">Creer un profil</a><?php } else {?><a  href="log/compte.php" class="">Compte</a><?php } ?></span></li>
	
		<li  class="" style=""><?php if(!isset ($_SESSION['email']) ){?><a  href="log/ins_login.php" class="">Se connecter</a><?php } else {?><a  href="deconnexion.php" class="">Deconnexion</a><?php } ?></span></li>
								...
								<?php
									...
									if(isset($_SESSION['panier']['libelleProduit']))
									{
										...
										?>
											...
											<div class="col-md-2">
											<a href="panier/ajout_panier.php?action=vider&amp;lien=<?php echo $page;?>"><i class="close" style="color:#000405;font-size:13px;font-style:normal">x</i></a>	
											</div>
...
<div class="col-md-12 divider">
			...
			<div class="col-md-12" style="border:1px solid #eeeeee;padding:10px 10px 0 10px">	<p><a href="panier/detail_panier.php" class="btn btn-primary" style="border-radius:0px;font-size:90%;width:100px">Panier</a> <a href="panier/paiement.php" class="btn btn-primary pull-right" style="border-radius:0px;;font-size:90%;width:100px">Caisse</a></p></div>
									</div>
...
<?php 
			...
			<li class="cash"><a id="cash" style="font-weight:6600"  href="panier/paiement.php">Caisse</a></li>
		...
		<li  class="" style="color:#fff"><a  href="#<?php echo $row_categorie['id'];?>" data-toggle="dropdown" class="dropdown-toggle "><?php echo $row_categorie['nom'];?></a></li>
		<?php } ?>
	   </ul>
        </div><!-- navbar-collapse -->
    </div> <!-- container -->
...
<div class="container">
			...
			<div class="col-sm-12 col-sm-offset-0">
            			...
            			<h4 class="art-title">Horloge murale Photo</h4>
				 <p class="p-lg">Domo splendido octavio. 
Maximasque. Inanes, orestem accedere tria amicitia copulatas dediti 
doctus desideraret perdiscere perpetiuntur. Attulit praeclara fingitur 
requietis fieri. Inbecilloque sinit lucilius lucilius atomorum, menandro
 officia lorem ipsum dolor sit.</p>
					
					<div class="col-md-12 col-sm-offset-0  ">
                     				<div class="gallery-item-x">
         						<img src="images/18164.jpg">
						</div>
<div class="col-md-12 col-sm-offset-0  ">
		...
		<div class="tab">   
			<ul id="tab" class="nav nav-tabs">
   				<li class="active"  ><a  href="#ios" data-toggle="tab">Description</a></li> 
   				<li class="" ><a href="#android" data-toggle="tab">Evaluations</a></li> 
			</ul>
		</div>
		<div id="TabContent" class="tab-content">
   			<div class="tab-pane fade in active" id="ios" style="margin-top:25px;padding:14px">
				<strong class="" style="color:#d14233;font-weight: 500;font-size:14px;text-transform:uppercase;margin-top:25px"> 
						Horloge murale Photo  ...  </strong>
         				 ...
         				 editor, wherein you can edit your code and try out different possibilities of 							the examples.</p>

			</div>
  			<div class="tab-pane fade in" id="android" style="margin-top:25px;padding:14px">
				<strong class="" style="color:#d14233;font-weight: 500;font-size:14px;text-transform:uppercase;margin-top:25px"> 
						Horloge murale Photo  ...  </strong>
       					<p>Tutorials Point is a place for beginners in all technical areas. 
         					This website covers most of the latest technoligies and explains 
				...
				<div class="col-sm-4 col-sm-offset-0">
					...
					<div class="cart-details-title">
						<h5 class="section-title text-center">Personnaliser le produit</h5>
            				</div>
					<div class="cart-details-t">
						<p class="section-title text-center">Lancer le configurateur pour télécharger la photo et personnaliser votre cadeau.</p>
            				</div>



					<div class="cart-details-cart">
						<!-- wang -->
...
<div class="col-md-12 divider">
			...
			<div class="col-md-12" style="border:1px solid #eeeeee;padding:10px 10px 0 10px">	<p><a href="panier/detail_panier.php" class="btn btn-primary" style="border-radius:0px;font-size:90%;width:100px">Panier</a> <a href="panier/paiement.php" class="btn btn-primary pull-right" style="border-radius:0px;;font-size:90%;width:100px">Caisse</a></p></div>
					...
					<div class="cart-details-total">
						<span class="section-title text-center">Quantité totale: 0</span>
            				</div> 
					<div class="cart-details-submit">
						<button type="submit" class="btn btn-primary pull-right" style="">Personnaliser</button>
					</div>
