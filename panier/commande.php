...
<a class="brand" href=""></a>
    ...
    <li style="height:20px; border-right: 1px solid #eeeeee;margin:15px 10px 0 10px;"></li>
		<li  class="" style="color:#fff"><?php if(!isset ($_SESSION['email']) ){?><a  href="../log/ins_login.php" class="" style="color:#fff;margin:0 0px 0 0;padding-left:0px;padding-right:0px;">Creer un profil </a><?php } else {?><a  href="../log/compte.php" class="">Compte</a><?php } ?></span></li>
	 <li style="height:20px; border-right: 1px solid #eeeeee;margin:15px 10px 0 10px;"></li>
    ...
    <div id="menu-container" class="main_menu">
		<div class="page-header">
			<ul class="nav navbar-nav" style="width:100%">
				...
				<li class="" style="width:25%"><a style=""  href="#" ><span class="badge-info" style="background:  #2d2925;">3</span><i class="label" style="font-size:14px;color: #2d2925;border-radius:0;padding:2px 10px 2px 10px">Paiement</i></a></li>
    ...
    <div class="modal-content">
     <div>
        <a style="background-color:transparent;color:#000405 ;width:35px;margin-left:100px;font-size:20px" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove-circle"></i></a>
			...
			<input type ="hidden" value ="<?php echo $page; ?> " id="lien">
				...
				<tr>
                        ...
                        <span class="btn btn-primary pull-right" style="border-radius:0px;font-size:90%;width:100px;color:#fff"><a style="color:#fff" href="paiement.php">Suite</a></span>
                      </div>
                    </div>
                </div>
   	     </div>
...
$(function() {
    ...
    $(".number-spinner button").mousedown(function () {
    	...
    	if (btn.attr('data-dir') == 'up') {
			...
			//window.alert(l);
			document.location.href="ajout_panier.php?action=modifier&lien="+lien+"&l="+l+"&q="+nbre;
			//document.location.href="ajout_panier.php?action=modifier&lien="+lien+"&l="+l+"&q="+nbre;
