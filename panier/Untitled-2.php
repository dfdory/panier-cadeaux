								...
								<?php
									...
									if(isset($_SESSION['panier']['libelleProduit']))
									{
										...
										?>
											...
											<div class="col-md-2">
											<a href="ajout_panier.php?action=suppression&amp;lien=<?php echo $page;?>&amp;l=<?php echo $_SESSION['panier']['libelleProduit'][$i];?>"><i class="close" style="color:#000405;font-size:13px;font-style:normal">x</i></a>	
											</div>
...
<?php 
    ...
    <div id="menu-container" class="main_menu">
		<div class="page-header">
			<ul class="nav navbar-nav" style="width:100%">
				<li class="" style="width:25%"><a  href="#" ><span class="badge-info" style="background:  #27B2EA;">1</span><i class="label " style="font-size:14px;color:  #27B2EA;border-radius:0;padding:2px 10px 2px 10px">Inscription</i></a></li>
				<li  class="active" style="width:25%"><a  href="#"class="text-error"><span class="badge-info"> 2 </span > <i class="label label-warning" style="font-size:14px;background:  #f4a62a;border-radius:0;padding:2px 10px 2px 10px"> Adresses</i></a></li>

				<li class="" style="width:25%"><a style=""  href="#" ><span class="badge-info" style="background:  #27B2EA;">3</span><i class="label" style="font-size:14px;color: #27B2EA;border-radius:0;padding:2px 10px 2px 10px">Paiement</i></a></li>
				<li id="" class="" style="width:25%"><a  href="#"><span class="badge-info" style="background:  #27B2EA;">4</span><i class="label" style="font-size:14px;color:  #27B2EA;border-radius:0;padding:2px 10px 2px 10px">Confirmation</i></a></li>
			</ul>
    ...
    <div class="modal-content">
     <div>
        <a style="background-color:transparent;color:#000405 ;width:35px;margin-left:100px;font-size:20px" type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove-circle"></i></a>
              ...
              <div>
              	 <form data-toggle="validator" role="form" id="myForm1" action="" method="post">
                                              ...
                                              <div class="panel-body">
                                                 ...
                                                 <?php 
												 	if($_SESSION['adresse']==$_SESSION['adresse_livraison']){
														 ...
														 echo $_SESSION['adresse_livraison'];
														}
												 ?>
								...
								?>
									<tr>
										<td>
                                        	...
                                        	<img src="../img/cadeau/thumbnail/<?php echo $_SESSION['panier']['imgProduit'][$i]; ?>" alt="">		    </td>
										<td ><?php echo $_SESSION['panier']['libelleProduit'][$i]; ?></td>
										<td><?php echo $_SESSION['panier']['prixProduit'][$i]; ?> </td>
										<td>
                                       <div class="input-group  number-spinner" id="<?php echo $i;?>">
				<span class="input-group-btn data-dwn">
					<button class="btn btn-default btn-info" data-dir="dwn"><span class="glyphicon glyphicon-minus"></span></button>
				</span>
				<input type="text" class="form-control text-center" value="<?php echo $_SESSION['panier']['qteProduit'][$i]; ?>" min="0" disabled width="50%">
                <input type ="hidden" value ="<?php echo $_SESSION['panier']['prixProduit'][$i]; ?> " id="prix">
            <input type ="hidden" value ="<?php echo $_SESSION['panier']['libelleProduit'][$i]; ?> " id="l">
				<span class="input-group-btn data-up">
					<button class="btn btn-default btn-info" data-dir="up"><span class="glyphicon glyphicon-plus"></span></button>
										...
										<td>
											<?php echo ($_SESSION['panier']['qteProduit'][$i] * $_SESSION['panier']['prixProduit'][$i]);?></td>
                                        <td><a href="ajout_panier.php?action=suppression&amp;lien=<?php echo $page;?>&amp;l=<?php echo $_SESSION['panier']['libelleProduit'][$i];?>"><i class="close" style="color:#000405;font-size:13px;font-style:normal">X</i></a></td>
									</tr>
								<?php 
							}
					   }
				...
				<tfoot>
				<tr>
						<th colspan="6" class="text-right ">Montant TotalS : <?php echo number_format(MontantGlobal(),0,'',' ');?> FCFA</th>
					</tr>
                        ...
                        <span class="btn btn-primary pull-right" style="border-radius:0px;font-size:90%;width:100px"><a href="paiement.php">Suite</a></span>
                      </div>
                    </div>
                </div>
   	     </div>
