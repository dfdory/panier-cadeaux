...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Pannier Cadeaux: Gestion des categories</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="index.php">Gestion des categories</a></li>
			</ul>
				...
				<div class="box span12">
                   ...
                   <?php } 
				   elseif((isset ($_GET['msg'])) and ($_GET['msg']==4))
					{
					?>
                    	<div class="navbar-text"><p> <h4 class=" text-left text-warning">Modification effectuee avec success</h4></p></div>
                   <?php } 
				   ?>
                       
                    
						<form class="form-horizontal" action="save_cat.php" method="post">
						  <fieldset>
			
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Nom de la categorie</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="categorie" required>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php while ($row_cat = mysql_fetch_array($query_categorie)){?>
							<tr>
								<td><?php echo $row_cat['nom'];?></td>
								
								<td class="center">
									<a class="btn btn-success" href="categorie_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<a class="btn btn-info" href="categorie_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="categorie_delete.php?id=<?php echo $row_cat['id'] ?>">
