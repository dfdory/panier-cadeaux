...
include('../conn.php');$query_etiquette = mysql_query('select * from etiquette');
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Pannier Cadeaux: Gestion des etiquettes</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li  class="active"><a href="etiquette.php"><i class="icon-certificate"></i><span class="hidden-tablet"> Gestion Etiquette</span></a></li>	
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Gestion des etiquettes</a></li>
			</ul>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Gestion des etiquettes</h2>
						<div class="box-icon">
				   ...
				   ?>
						...
						<form class="form-horizontal" action="save_eti.php" method="post">
						  <fieldset>
						
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Etiquettes</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="etiquette" required >
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon sitemap"></i><span class="break"></span>liste des Etiquettes</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php while ($row_cat = mysql_fetch_array($query_etiquette)){?>
							<tr>
								<td><?php echo $row_cat['nom'];?></td>
								
								<td class="center">
									<a class="btn btn-success" href="etiquette_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<a class="btn btn-info" href="etiquette_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="etiquette_delete.php?id=<?php echo $row_cat['id'] ?>">
