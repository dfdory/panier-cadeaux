...
$query_destinataire = mysql_query("select * from destinataire where id=$id");

$row_cat = mysql_fetch_array($query_destinataire);
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li class="active"><a href="destinataire.php"><i class="icon-user-md"></i><span class="hidden-tablet"> Gestion destinataire</span></a></li>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="save_destinataire_edit.php" method="post">
						  <fieldset>
						
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Destinataire</label>
								<div class="controls">
								  <input type="text" id="" name="destinataire" value="<?php echo $row_cat['nom'];?>" required>
