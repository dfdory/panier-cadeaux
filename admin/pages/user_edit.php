...
$$query_admin = mysql_query("select * from admin where id=$id");

$row_cat = mysql_fetch_array($query_admin);
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
				   ...
				   ?>
						...
						<form class="form-horizontal" action="save_user_edit.php" method="post">
						  <fieldset>
			
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Nom </label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="nom" value ="<?php echo $row_cat['nom'];?>" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="prenom" value ="<?php echo $row_cat['prenom'];?>" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="login" value ="<?php echo $row_cat['login'];?>" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="password" id="inputSuccess" name="pwd" value ="********" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="email" id="inputSuccess" name="email" value ="<?php echo $row_cat['email'];?>"  required>
