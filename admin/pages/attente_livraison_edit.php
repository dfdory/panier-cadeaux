			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Enclancher le processus de Livraison</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="save_attente_livraison_edit.php" method="post">
						  <fieldset>
							 <div class="control-group">
								<label class="control-label">Reference Commande</label>
								<div class="controls">
                              ...
                              <div class="control-group">
							  <label class="control-label" for="date01">Date livraison</label>
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="date01" value="" name="date_fin_livraison"  required>
							  </div>
							</div>
