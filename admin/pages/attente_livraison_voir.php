...
include('../conn.php');
$id=$_GET['id'];
$query_categorie = mysql_query("select * from commande where id=$id");
...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Pannier Cadeaux: Detail d'une commande</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="index.php">Detail d'une commande</a></li>
			</ul>
				...
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Detail de la commande: </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="" method="">
						  <fieldset > <legend>information sur la commande:</legend>
								<div class="control-group">
								<label class="control-label">Reference </label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['ref_cmd'];?></span>
								</div>
							  </div>
							<div class="control-group">
								<label class="control-label">Statut</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php if ($row_cat['statut']==1){echo 'Paiement effectue';} ?></span>
								</div>
							  </div>
                              <div class="control-group">
								<label class="control-label">Etat</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php if($row_cat['id_etat']==""){echo 'R.A.S'; }
								else{$id_etat = $row_cat['id_etat'];
								$querry_etat = mysql_query("select * from etat_cmd where id=$id_etat");
								$row_etat1 = mysql_fetch_array($querry_etat);
								echo $row_etat1['nom'];}?></span>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label">Effectuee Le</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['date_cmd'];?></span>
								</div>
							  </div>
                              <div class="control-group">
								<label class="control-label">Livree entre le</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['date_dt_livraison'];?></span>
								  
								</div>
								<label class="control-label">&nbsp; et le</label> 
								<div class="controls">
								<span class="input-xlarge uneditable-input"><?php echo $row_cat['date_fin_livraison'];?></span>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label">Montant</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['montant_th'];?>&nbsp; FCFA</span>
								</div>
							  </div>
							  <legend>information sur la facture:</legend>
							  <div class="control-group">
								<label class="control-label">Adresse de facturation</label>
								<div class="controls">
								  <textarea class="input-xlarge uneditable-input"><?php echo $row_cat['adresse_facture'];?></textarea>
								</div>
							  </div>
								 <div class="control-group">
								<label class="control-label">Client</label>
								<div class="controls">
								  <textarea class="input-xlarge uneditable-input">
								  <?php $id_etat = $row_cat['id_membre'];
								$querry_etat = mysql_query("select * from membre where id=$id_etat");
								$row_etat1 = mysql_fetch_array($querry_etat);
								echo $row_etat1['nom'].' '.$row_etat1['prenom'].' '.$row_etat1['email'].' '.$row_etat1['tel'];?></textarea>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label">Adresse Livraison </label>
								<div class="controls">
								  <textarea class="input-xlarge uneditable-input"><?php echo $row_cat['adresse_livraison'];?></textarea>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label">Nom du Receptionniste</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['nom_receptioniste'];?></span>
								</div>
							  </div>
							   <div class="control-group">
								<label class="control-label">Tel du Receptionniste</label>
								<div class="controls" >
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['tel_receptioniste'];?></span>
								</div>
							  </div>
							   <div class="control-group">
								<label class="control-label">Nom du Receptionniste correctement ecrit</label>
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><?php echo $row_cat['nom_correct'];?></span>
								</div>
							  </div>
							  <legend>Information sur les articles</legend>
							  <?php 
						...
						?><table class="table">
						  ...
						  while($row_list_article = mysql_fetch_array($list_article)){
								...
								?>
                                <tr>
                                	<td><?php echo $row_cado['nom'];?></td>
                                    <td><?php echo $row_list_article['qte'];?></td>
                                    <td><?php echo $row_cado['prix'];?> FCFA</td>
                                    <td><?php echo ($row_cado['prix']* $row_list_article['qte']);?> FCFA</td>
                                </tr>
                                <?php
								}?>
						  </tbody>
						  ...
						  <legend>Mode de paiement</legend>
							<div class="form-actions">
							  ...
							  <button type="submit" class="btn btn-primary" name="add">Imprimer</button>
