...
$query_etiquette = mysql_query("select * from etiquette where id=$id");

$row_cat = mysql_fetch_array($query_etiquette);
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
				   ...
				   ?>
						...
						<form class="form-horizontal" action="save_etiquette_edit.php" method="post">
						  <fieldset>
						
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Etiquettes</label>
								<div class="controls">
								 <input type="text" id="" name="etiquette" value="<?php echo $row_cat['nom'];?>" required>
