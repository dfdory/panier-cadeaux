			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="save_etat_edit.php" method="post">
						  <fieldset>
							 <div class="control-group">
								<label class="control-label" for="">Code de l'etat</label>
								<div class="controls">
								  <input type="text" id="" name="code" value="<?php echo $row_cat['code_etat'];?>" required>
								  
								</div>
							  </div>
                            <div class="control-group">
								<label class="control-label" for="">Nom de l'etat</label>
								<div class="controls">
								  <input type="text" id="" name="etat" value="<?php echo $row_cat['nom'];?>" required>
