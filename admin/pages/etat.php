...
include('../conn.php');
$query_etat = mysql_query('select * from etat_cmd');
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
				   ...
				   ?>
						...
						<form class="form-horizontal" action="save_etat.php" method="post">
						  <fieldset>
			
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Code</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="code" required>
								  
								</div>
							  </div>
							 <div class="control-group">
								<label class="control-label" for="inputSuccess">Nom etat</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="etat" required>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								<td><?php echo $row_cat['code_etat'];?></td>
								<td><?php echo $row_cat['nom'];?></td>
								<td class="center">
									<a class="btn btn-success" href="etat_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<a class="btn btn-info" href="etat_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="etat_delete.php?id=<?php echo $row_cat['id'] ?>">
