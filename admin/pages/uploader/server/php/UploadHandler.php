...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/admin/pages/uploader/server/php/',
            'upload_dir' => '../../../../../img/cadeau/',
            'upload_url' => $this->get_full_url().'/img/cadeau/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_full_url() {
        ...
        return
            ...
            $_SERVER['SERVER_PORT'] === 80 ? '' : ':'.$_SERVER['SERVER_PORT']))).'/panier_cadeau';
