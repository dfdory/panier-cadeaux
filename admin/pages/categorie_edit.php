...
$query_categorie = mysql_query("select * from categorie where id=$id");
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
					...
					<div class="box-content">
						...
						<form class="form-horizontal" action="save_categorie_edit.php" method="post">
						  <fieldset>
			
                            <div class="control-group">
								<label class="control-label" for="">Nom de la categorie</label>
								<div class="controls">
								  <input type="text" id="" name="categorie" value="<?php echo $row_cat['nom'];?>" required>
