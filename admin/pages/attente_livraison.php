...
include('../conn.php');
$query_etat = mysql_query('select * from commande where id_etat =1 order by date_cmd DESC');
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>COMMANDE EN ATTENDE DE LIVRAISON</h2>
						<div class="box-icon">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon sitemap"></i><span class="break"></span>liste des commande</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
						  ...
						  <tbody>
							<?php while ($row_cat = mysql_fetch_array($query_etat)){?>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="attente_livraison_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>circuit livraison                                            
									</a>
