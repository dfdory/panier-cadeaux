...
include('../conn.php');
$query_etat = mysql_query('select * from commande where id_etat =2 order by date_cmd DESC');
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Pannier Cadeaux: Gestion des Livraisons</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="index.php">Gestion des Livraisons</a></li>
			</ul>
				...
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>COMMANDE EN COURS DE LIVRAISON</h2>
						<div class="box-icon">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon sitemap"></i><span class="break"></span>liste des commandes</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php while ($row_cat = mysql_fetch_array($query_etat)){?>
							
								<tr>
                                <td><?php echo $row_cat['ref_cmd']; ?></td>
                                <td><?php echo $row_cat['date_cmd']; ?></td>
                                <td><?php echo $row_cat['montant_th']; ?></td>
                                <td><?php if ($row_cat['statut']==1){echo 'Paiement effectue';} ?></td>
                                <td><?php if($row_cat['id_etat']==""){echo 'R.A.S'; }
								...
								echo $row_etat1['nom'];}?></td>
                                
								<td class="center">
									<a class="btn btn-success" href="attente_livraison_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>detail                                            
									</a>
									<a class="btn btn-info" href="confirme_livraison_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>confirmer livraison                                            
									</a>
