...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Pannier Cadeaux: Gestion des administrateurs</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li  class="active"><a href="user.php"><i class="icon-user"></i><span class="hidden-tablet"> Gestion des administrateurs</span></a></li>
			...
			<ul class="breadcrumb">
				...
				<li><a href="index.php">Gestion des Administrateurs</a></li>
			</ul>
				...
				<div class="box span12">
					...
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Gestion des Administrateurs</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" action="save_user.php" method="post">
						  <fieldset>
                            ...
                            <div class="control-group">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="nom" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="prenom" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="login" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="password" id="inputSuccess" name="pwd" required>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="email" id="inputSuccess" name="email" required>
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon sitemap"></i><span class="break"></span>liste des categories</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<?php while ($row_cat = mysql_fetch_array($query_admin)){?>
							<tr>
								<td><?php echo $row_cat['nom'];?></td>
								<td><?php echo $row_cat['prenom'];?></td>
								
								<td class="center"><?php echo $row_cat['email'];?></td>
								<td class="center">
									<span class="label label-success"><?php echo $row_cat['login'];?></span>
								</td>
								
								<td class="center">
									<a class="btn btn-success" href="user_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<a class="btn btn-info" href="user_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="user_delete.php?id=<?php echo $row_cat['id'] ?>">
