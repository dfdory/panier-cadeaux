...
include('../conn.php');$query_occasion = mysql_query('select * from occasion');
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<ul class="breadcrumb">
				...
				<div class="box span12">
				   ...
				   ?>
						...
						<form class="form-horizontal" action="save_occ.php" method="post">
						  <fieldset>
						
                            <div class="control-group">
								<label class="control-label" for="inputSuccess">Occasions</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="occasion" required >
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon sitemap"></i><span class="break"></span>liste des occasions</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php while ($row_cat = mysql_fetch_array($query_occasion)){?>
							<tr>
								<td><?php echo $row_cat['nom'];?></td>
								
								<td class="center">
									<a class="btn btn-success" href="occassion_voir.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<a class="btn btn-info" href="occassion_edit.php?id=<?php echo $row_cat['id'] ?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="occassion_delete.php?id=<?php echo $row_cat['id'] ?>">
